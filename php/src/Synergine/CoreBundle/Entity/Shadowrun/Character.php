...
/**
 * @ORM\Entity
 * @ORM\Table(name="sr_character")
 */
class Character {
   const METATYPE_HUMAN = 1;
   const METATYPE_ELF = 2;
   const METATYPE_ORC = 3;
   const METATYPE_TROLL = 4;
    ...
    * @ORM\JoinColumn(referencedColumnName="game_id")
    * @var Game
    */
   protected $game;
    ...
    * @ORM\JoinTable(name="sr_character_quality")
    * @var Quality[]
    */
   protected $qualities;
    ...
    * @ORM\JoinTable(name="sr_character_maneuver")
    * @var Maneuver[]
    */
   protected $maneuvers;
    ...
    * @ORM\JoinTable(name="sr_character_spell")
    * @var Spell[]
    */
   protected $spells;
